...
void abAppend(struct a_buf *ab, const char *s, int len) {
...
void editorScroll() {
	...
	if (E.rx >= E.col_off + E.screen_columns) {
		E.col_off = E.rx - E.screen_columns + 1;
	}
}
